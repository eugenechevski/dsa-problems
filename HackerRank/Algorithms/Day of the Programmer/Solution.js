/*
    ...
    Problem:
        ...
        * Divisible by 4 and not divisible by 100.
        ...
        For example, the given year = 1984. 1984 is divisible by 4, so it is a leap year. The 256th day of a leap year after 1918 is 
...
function dayOfProgrammer(year) {
    let holidayDate = '.09.' + year;
    let day = '';

    // 1. Determine if the year is 1918
    if (year == '1918') {
        day = '26';
    // 2. Determine the type of calendar and if it's leap year
    } else if ((year < 1918 && year % 4 == 0) ||
               (year > 1918 && year % 400 == 0 || (year % 4 == 0 && year % 100 != 0))) {
        day = '12';
    
    // 3. If the year is not leap, then the day always will be the September 13th
    } else {
        day = '13'
    }

    return day + holidayDate;
}
